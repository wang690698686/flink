...
/**
 * Levenshtein Distance算法(中文翻译：编辑距离算法) 计算文本相似
 */
public class SimFeatureUtil {
	...
	public static void main(String[] args) {
		String str1 = "普京高度评价习主席在俄中关系发展中发挥的重要作用，强调不久前习主席对俄进行国事访问取得圆满成功了";
		String str2 = "普京高度评价习主席在俄中关系发展中发挥的重要作用，强调不久前习主席对俄进行国事访问取得圆满成功";
